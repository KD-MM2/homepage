...
You'll need to create Long-Lived Tokens (API Tokens). 
Follow the official documentation steps here: [Sessions & API Tokens - Long-Lived Tokens (API Tokens)](https://coder.com/docs/admin/users/sessions-tokens#long-lived-tokens-api-tokens)
